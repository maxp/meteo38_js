...
(function() {
  var GRAPH_DAYS, ST_LIST_COOKIE, ST_LIST_DEFAULT, TRENDS_INTERVAL, app, config, db, debug, exp, express, fetch_data, fetch_sts, get_stlist, info, lib, moment, st_list_cleanup, warn, _ref, _ref1;
