...
(function() {
  var DAYNUM_MAX, ST_LIST_COOKIE, ST_LIST_DEFAULT, TRENDS_INTERVAL, app, body_parser, compress, config, cookie_parser, db, debug, error_handler, exp, express, fetch_data, fetch_sts, get_stlist, info, lib, moment, serve_static, st_list_cleanup, warn, _ref, _ref1;
