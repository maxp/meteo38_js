...
(function() {
  var $btn_stlist, REFRESH_INTERVAL, TRENDS_INTERVAL, ZOOM_INIT, fav_item_click, favs_add, favs_remove, format_t, lib, ll2coords, load_stlist, map, refresh_data, save_favs, show_graph, show_map, star_click,
  ...
  show_map = function() {
    if (!window.map) {
      window.ymaps_onload = function() {
        ...
        center = ll2coords((_ref = window.st_data[st0]) != null ? _ref.ll : void 0) || [52.27, 104.26];
