...
(function() {
  ...
  ST_LIST_DEFAULT = ["asbtv", "npsd", "uiii", "istok", "kovcheg", "basenet", "bgkgs2", "zbereg", "soln", "irk2", "olha"];
    ...
    return fetch_sts(st_list, function(data) {
      return res.render("app/main", {
        ...
        format_t: function(last, trends) {
          var acls, cls, ref2, sign, t, tr, tts;
          if (last.t == null) {
            return "";
          }
          t = Math.round(last.t);
          ref2 = t > 0 ? ["pos", "+"] : t < 0 ? ["neg", "-"] : ["zer", ""], cls = ref2[0], sign = ref2[1];
          if (t < 0) {
            t = -t;
          }
          tr = " &nbsp;";
