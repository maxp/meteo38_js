...
(function() {
  var $btn_stlist, CENTER_INIT, HPA_MMHG, REFRESH_INTERVAL, TRENDS_INTERVAL, ZOOM_INIT, add_marker, fav_item_click, favs_add, favs_remove, format_p, format_t, format_w, lib, ll2coords, load_stlist, map, markers, refresh_data, remove_marker, save_favs, show_map, star_click, title_t, update_stdata, wind_nesw,
    ...
    return window.refresh_tout = setTimeout(function() {
      ...
      return $.getJSON("/st_data", {
        ...
        for (_i = 0, _len = st_list.length; _i < _len; _i++) {
          ...
          d = resp.data[s];
          if (d) {
            $("#favst_" + d._id + " .data").html(format_t(d.last, d.trends)).append($("<div class='p'></<div>").html(format_p(d.last))).append($("<div class='w'></<div>").html(format_w(d.last)));
          } else {
            $("#favst_" + s + " .data").html("");
          }
        }
