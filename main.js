...
(function() {
  var DAYNUM_MAX, HPA_MMHG, ST_LIST_COOKIE, ST_LIST_DEFAULT, TRENDS_INTERVAL, app, compress, config, cookie_parser, db, debug, error_handler, exp, express, fetch_data, fetch_sts, get_stlist, info, lib, moment, ref, ref1, serve_static, st_list_cleanup, warn, wind_nesw,
