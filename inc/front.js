...
(function() {
  var $btn_stlist, REFRESH_INTERVAL, TRENDS_INTERVAL, favs_add, favs_remove, format_t, init_map, lib, load_stlist, refresh_data, save_favs, show_graph, show_map, star_click,
  ...
  show_map = function() {
    if (!window.map) {
      ...
      $.getScript("//api-maps.yandex.ru/2.0-stable/?lang=ru-RU" + "&load=package.standard&coordorder=longlat&onload=ymaps_onload");
    }
  };
