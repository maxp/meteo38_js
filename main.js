...
(function() {
  var ST_LIST_COOKIE, ST_LIST_DEFAULT, TRENDS_INTERVAL, app, config, debug, express, fetch_sts, get_stlist, info, lib, st_list_cleanup, warn, _ref, _ref1;
  ...
  _ref1 = require('./app'), st_list_cleanup = _ref1.st_list_cleanup, fetch_sts = _ref1.fetch_sts, get_stlist = _ref1.get_stlist;
